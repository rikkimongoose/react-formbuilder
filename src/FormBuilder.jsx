...
class FormBuilder extends React.Component {
  ...
  render() {
    ...
    const doAdd = (controlType) => {
      ...
      const newControl = controlType.create()
      constolsCurrent.push( { ...control, id: generateUUID() });
    ...
    const doCopy = (control) => {
      ...
      constolsCurrent.push(newControl);
      this.setState({controlsCurrent});
    };

    const doDelete = (control) => {
      const controlsCurrent = { this.state };
      this.setState({controlsCurrent.filter(c => c.id !== control.id )});
    };
    ...
    const doUpdate = (control) => {
      ...
      if(baseControl){
        ...
        constolsCurrent[controlIndex] = control;
      } else {
        constolsCurrent.push(control);
      }
      this.setState({controlsCurrent});
    };
